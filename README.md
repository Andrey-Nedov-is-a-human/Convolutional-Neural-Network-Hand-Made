...
3. Входные нейроны (Si, i = 1,2...n) формируют сигналы Xi для скрытого слоя
...
Затем вычисляет изменение веса связи ΔWjk = a\*σk\*Hj, где a - коэффицент обучения (Learning rate), и величину корректировки смещения W0k = a\*σk
...
σk = (Tk - Rk)\*f'(Rin_k). 
Затем вычисляет изменение веса связи ΔWjk = a \* σk * Hj, где a - коэффицент обучения (Learning rate), и величину корректировки смещения ΔW0k = a \* σk/
